...
function deserializeValue(value, options) {
    ...
    if (typeof value === 'number') {
        ...
        if (Math.floor(value) === value) {
            if (value >= BSON_INT32_MIN$1 && value <= BSON_INT32_MAX$1) return new Int32(value);
            if (value >= BSON_INT64_MIN$1 && value <= BSON_INT64_MAX$1) return Long.fromNumber(value);
        }
        ...
        case 'object':
            if (value == null || value['_bsontype'] === 'MinKey' || value['_bsontype'] === 'MaxKey') {
                ...
                if (value.scope != null && Object.keys(value.scope).length > 0) {
                    return (name != null ? Buffer.byteLength(name, 'utf8') + 1 : 0) + 1 + 4 + 4 + Buffer.byteLength(value.code.toString(), 'utf8') + 1 + calculateObjectSize$1(value.scope, serializeFunctions, ignoreUndefined);
                } else {
                ...
                return (name != null ? Buffer.byteLength(name, 'utf8') + 1 : 0) + 1 + calculateObjectSize$1(ordered_values, serializeFunctions, ignoreUndefined);
                ...
                return (name != null ? Buffer.byteLength(name, 'utf8') + 1 : 0) + calculateObjectSize$1(value, serializeFunctions, ignoreUndefined) + 1;
            }
        case 'function':
            ...
            if (value instanceof RegExp || isRegExp(value) || String.call(value) === '[object RegExp]') {
                ...
                if (serializeFunctions && value.scope != null && Object.keys(value.scope).length > 0) {
                    return (name != null ? Buffer.byteLength(name, 'utf8') + 1 : 0) + 1 + 4 + 4 + Buffer.byteLength(normalizedFunctionString(value), 'utf8') + 1 + calculateObjectSize$1(value.scope, serializeFunctions, ignoreUndefined);
...
function serializeInto(buffer, object, checkKeys, startingIndex, depth, serializeFunctions, ignoreUndefined, path) {
    ...
    if (Array.isArray(object)) {
        ...
        if (object.toBSON) {
            ...
            object = object.toBSON();
            if (object != null && typeof object !== 'object') throw new BSONTypeError('toBSON function did not return an object');
        }
