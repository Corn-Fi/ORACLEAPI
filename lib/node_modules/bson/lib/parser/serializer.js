    ...
    if (Array.isArray(object)) {
        ...
        for (var i = 0; i < object.length; i++) {
            ...
            if (value && value.toBSON) {
                if (typeof value.toBSON !== 'function') throw new error_1.BSONTypeError('toBSON is not a function');
                value = value.toBSON();
            }
        ...
        if (object.toBSON) {
            if (typeof object.toBSON !== 'function') throw new error_1.BSONTypeError('toBSON is not a function');
            object = object.toBSON();
            if (object != null && typeof object !== 'object') throw new error_1.BSONTypeError('toBSON function did not return an object');
        }
